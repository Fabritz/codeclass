...
const UProfesorPage = () => {
  const [group1203value, setGroup1203value] = React.useState("");
          ...
          <div className="flex flex-1 flex-col md:gap-10 gap-[122px] justify-start md:mt-0 mt-[76px] md:px-5 w-full">
            ...
            <div className="flex flex-col gap-[49px] items-center justify-start w-full">
              <Input
                ...
                value={group1203value}
                onChange={(e) => setGroup1203value(e)}
                ...
                suffix={
                  <CloseSVG
                    fillColor="#8b8e95"
                    className="cursor-pointer my-auto"
                    onClick={() => setGroup1203value("")}
                    style={{
                      visibility:
                        group1203value?.length <= 0 ? "hidden" : "visible",
                    }}
                    height={38}
                    width={41}
                    viewBox="0 0 41 38"
